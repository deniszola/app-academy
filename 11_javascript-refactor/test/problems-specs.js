...
describe("Problems", function () {
  ...
  describe("bothStringsIncluded", function () {
    it("should return true if both strings are in the sentence", function () {
      expect(
        bothStringsIncluded("I'm having a great time", "great", "nope")
      ).to.equal(false);
      expect(
        bothStringsIncluded("I'm having a great time", "great", "time")
      ).to.equal(true);
      expect(
        bothStringsIncluded("I'm having a great time", "wrong", "words")
      ).to.equal(false);
    });
  });

  describe("productArray", function () {
    it("should return the product of all the elements in the array", function () {
