...
and refactor the `promptInput(rl)` main function to use the `printHelp()`
function.

Take a look at the test specs for the `printHelp()` function in
**test/phase-01-printHelp-spec.js**. You can run the test specs in the file
...
all the test specs in every file in the **test** folder.)
...
helper function and refactor the `promptInput(rl)` main function to use the
`getWinner(move1, move2)` function.

Take a look at the test specs for the `getWinner(move1, move2)` function in
**test/phase-02-getWinner-spec.js**. You can run the test specs in the file
with the following command:
...
and refactor the `promptInput(rl)` main function to use the `getCPUMove()`
function.

Take a look at the test specs for the `getCPUMove()` function in
**test/phase-03-getCPUMove-spec.js**. You can run the test specs in the file
with the following command:
...
function and refactor the `promptInput(rl)` main function to use the
`processMove(cmd, cpu)` function.

Take a look at the test specs for the `processMove(cmd, cpu)` function in
**test/phase-04-processMove-spec.js**. You can run the test specs in the file
with the following command:
