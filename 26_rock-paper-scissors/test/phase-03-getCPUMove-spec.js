...
describe("getCPUMove()", () => {
  ...
  it("should return 'r' at least once after many calls", () => {
    ...
    expect(
      returnedMoveKeys.includes("r"),
      "Expected 'r' to be returned at least once after many calls"
    ).to.be.true;
  });
  ...
  it("should return 'p' at least once after many calls", () => {
    ...
    expect(
      returnedMoveKeys.includes("p"),
      "Expected 'p' to be returned at least once after many calls"
    ).to.be.true;
  });
  ...
  it("should return 's' at least once after many calls", () => {
    ...
    expect(
      returnedMoveKeys.includes("s"),
      "Expected 's' to be returned at least once after many calls"
    ).to.be.true;
  });
});
