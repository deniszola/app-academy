...
Take a look at the code in the **greet.js** file.
...
Take a look at the code in the **grade.js** file.

The code instantiates a new `Gradebook` imported from the
**classes/gradebook.js** file.

If you run the **grade.js** file with `node greet.js`, you will get an error.
