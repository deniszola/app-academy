...
describe("Person class", () => {
  ...
  describe("Person instance method introduce", () => {
    it("should still behave the same as before", () => {
      expect(person1.introduce()).to.eql(
        `Hi, I'm kristen chauncey, and I'm 38 years old.`
      );
    });
  });
});
...
describe("Student class", () => {
  ...
  describe("Student instance method introduce", () => {
    it("should call the unique introduce method for Student", () => {
      expect(student1.introduce()).to.eql(
        "Hello. I am billy johnson, and I study software-development."
      );
    });
  });
});
...
describe("Teacher class", () => {
  ...
  describe("Teacher instance method introduce", () => {
    it("should call the unique introduce method for Student", () => {
      expect(teacher1.introduce()).to.eql(
        "Hello. I am susan jones, and I have been teaching biology for 5 years."
      );
    });
  });
});
