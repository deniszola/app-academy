...
used to _change appearance, behaviour, or state_. In this case, it changes the
...
each they're not. If you adjust the size of the window, the images will re-flow
